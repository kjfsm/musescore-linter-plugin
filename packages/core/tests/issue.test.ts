...
import { createIssue, compareIssues } from "../src/issue.js";
...
describe("createIssue", () => {
  ...
  it("fields.severity で上書きできる", () => {
    const issue = createIssue(mockChecker, { severity: "error", message: "test" });
...
describe("compareIssues", () => {
  it("measure → staffIdx → severity → tick の順でソートされる", () => {
    const issues: Issue[] = [
      { ruleId: "a", severity: "info",    category: "", message: "", partName: "", staffIdx: 0, measure: 2, tick: 0,   detail: null },
      { ruleId: "b", severity: "error",   category: "", message: "", partName: "", staffIdx: 1, measure: 1, tick: 500, detail: null },
      { ruleId: "c", severity: "warning", category: "", message: "", partName: "", staffIdx: 0, measure: 1, tick: 0,   detail: null },
      { ruleId: "d", severity: "error",   category: "", message: "", partName: "", staffIdx: 0, measure: 1, tick: 0,   detail: null },
    ];
